...
import {View, Text, TurboModuleRegistry, Alert} from 'react-native';
...
const Chart1 = props => {
  ...
  }, [option, chartWidth, chartHeight, props.data]);
  // 获取容器的宽高
