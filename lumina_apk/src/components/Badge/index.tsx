...
const Badge = (props: BadgeProps & ViewProps) => {
  ...
  return (
    ...
    useInlineStyle({ justifyContent: 'center', display: 'flex', flexDirection: 'row', height: 40, minWidth: 40,alignItems:'center',paddingBottom:5, })]}>
      <AutoText style={{ color: '#fff',paddingTop:9, }} size={24}>{props.count}</AutoText>
    </View>
  );
};
