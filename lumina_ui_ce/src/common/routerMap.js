...
export const LocalRouterMap = {
  '/': { title:<Trans i18nKey="LocalRouterMap.index" />   , icon: <HomeOutlined /> },
  '/user': { title: <Trans i18nKey="LocalRouterMap.user" />, icon: <UsergroupAddOutlined />, element: <User /> },
  '/zone': { title: <Trans i18nKey="LocalRouterMap.zone" />, icon: <ApartmentOutlined />, element: <Zone /> },
  '/room': { title: <Trans i18nKey="LocalRouterMap.room" />, icon: <LockOutlined />, element: <Room /> },
  '/unit': { title: <Trans i18nKey="LocalRouterMap.unit" />, icon: <ClusterOutlined />, element: <Unit /> },
  '/three_table': { title: <Trans i18nKey="LocalRouterMap.three_table" />, icon: <ClusterOutlined />, element: <ThreeTable /> },
