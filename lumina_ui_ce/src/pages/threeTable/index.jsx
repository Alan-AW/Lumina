...
function ThreeTable() {
    ...
    const tableTitle = [
        ...
        {
            title: t("threeTable.tableTitle.name_cn"),
            align: 'center',
            dataIndex: 'name_cn'
        },
        {
            title: t("threeTable.tableTitle.description_en"),
            align: 'center',
            dataIndex: 'description_en'
        },
        {
            title: t("threeTable.tableTitle.description_cn"),
            align: 'center',
        ...
        },
        {
            ...
            render: row => (
                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-evenly' }}>
                    ...
                    />
                    <Popconfirm
                        title={t("threeTable.deltitle")}
                        description={t("threeTable.description")}
                        okText="Yes"
                        okType='danger'
                        cancelText="No"
